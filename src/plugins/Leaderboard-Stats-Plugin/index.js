...
time = ttime.replace(/\..+/, '');
  lb[0] = "~~~~~Stats~~~~~";
  lb[1] = "Minions: " + minions;
  lb[2] = "Bots: " + bots;
  lb[3] = "~~~~~~~~~~~~~~~";
  lb[4] = "Spectators: " + spectators;
  lb[5] = "Highscore: " + Math.floor(gameServer.topscore);
  lb[6] = "By: " + gameServer.topusername;
  lb[7] = "Prev: " + gameServer.oldtopscores.name;
  lb[8] = "~~~~~~~~~~~~~~~";
